...
TEST(TestSymmetry, DetectRotationalSymmetry)
{   
    int i;
...
TEST(TestSymmetry, DetectRotationalSymmetryOrder)
{
    int i;
    ...
    EXPECT_EQ(Sym.rot_sym_along_bond(Alanin_ptr, alanin_atoms, 0, 1), 1);
    EXPECT_EQ(Sym.rot_sym_along_bond(Alanin_ptr, alanin_atoms, 1, 0), 1);
    EXPECT_EQ(Sym.rot_sym_along_bond(Alanin_ptr, alanin_methyl_atoms, 0, 2), 3);
    EXPECT_EQ(Sym.rot_sym_along_bond(Alanin_ptr, alanin_methyl_atoms, 2, 0), 3);
    ...
    EXPECT_EQ(Sym.rot_sym_along_bond(Tyrosin_ptr, tyrosin_atoms, 13, 16), 1);
    EXPECT_EQ(Sym.rot_sym_along_bond(Tyrosin_ptr, tyrosin_ring_atoms, 4, 12), 2);
}